...
export const RequestFile = React.createClass({
    mixins: [React.addons.LinkedStateMixin],

    sendRequestAccessFile(event) {
        event.preventDefault();
        var currentLocation = this.props.location.pathname;
        var record_id = currentLocation.match(/\w{16}[A-Za-z0-9]*/);
        var data = {
        ...
        browserHistory.push(`/records/${record_id[0]}/accessrequestsent`);
        serverCache.requestAccessFile( record_id[0] , data , false);
    },
            	...
            	<form className="form-horizontal" onSubmit={this.sendRequestAccessFile}>                        
                    <div className='row'>
                        ...
                        <div className="col-sm-6" >	                    	
                        	<input ref='full_record_link' className="form-control" name='full_record_link' type='text' value={currentLocation.match(/^\/[A-Za-z0-9_\/-]*\//)} readOnly="true" size='60' />
                    	</div>
                    </div> 
