...
module.exports = function(props) {
  return (
    <div className='rest_api'>
		...
		<h3>Upload a new file into a deposition object</h3>
		...
		<h3>List the files uploaded into a deposition object</h3>
