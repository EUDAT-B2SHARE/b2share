...
# # Modified version of WebDeposit for SimpleStore purposes
# # Made some format changes to stasify pep8

"""SimpleDeposit Flask Blueprint"""
import os
import shutil
import json
...
from invenio.simpledeposit_load_deposition_types import (deposition_types,
                                                         deposition_metadata)
from invenio.webinterface_handler_flask_utils import _, InvenioBlueprint

from invenio.config import CFG_WEBDEPOSIT_UPLOAD_FOLDER
from invenio.sherpa_romeo import SherpaRomeoSearch
from invenio.webdeposit_utils import (get_current_form, draft_field_set,
                                      draft_field_list_add, delete_workflow,
                                      create_workflow,
                                      get_latest_or_new_workflow, get_workflow,
                                      draft_field_get_all)
from invenio.webuser_flask import current_user
from invenio.webdeposit_workflow import CFG_WEBDEPOSIT_WORKFLOW_STATUS

blueprint = InvenioBlueprint('simpledeposit', __name__,
                             url_prefix='/simpledeposit',
                             config='invenio.websubmit_config',
                             menubuilder=[('main.simpledeposit',
                                           _('SimpleDeposit'),
                                           'simpledeposit.index_deposition_types', 2)],
                             breadcrumbs=[(_('SimpleDeposit'), 'simpledeposit.index_deposition_types')])
...
def index_deposition_types():
    ...
    return render_template('simpledeposit_index_deposition_types.html',
