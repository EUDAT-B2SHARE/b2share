...
%(outro2)s""" % {
            'intro': _("We have received an account activation request via %(x_sitename)s "
              "for the email address \"%(x_email)s\"." % {
                    'x_sitename': "b2share.eudat.eu",
                    'x_email' : email,
                    'x_ip_address' : ip_address,
                    }
                ),
            'intro2' : _("If you would like to complete this account registration, please go to:"),
            'link' : "%s/youraccount/access%s" %
                (CFG_SITE_SECURE_URL, make_canonical_urlargd({
                    'ln' : ln,
                    'mailcookie' : address_activation_key
                }, {})),
            'outro' : _("to confirm the validity of this request."),
